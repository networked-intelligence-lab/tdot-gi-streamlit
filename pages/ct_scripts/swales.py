def swales_tab(tab_object):
    ...
    base_facility_cost = tab_object.number_input('Base Facility Cost per acre DA ($)', value=3000)
    default_cost_adjustment = tab_object.number_input('Default Cost Adjustment fro Smaller Projects', value=2.2)
    resulting_base_cost = tab_object.number_input('Resulting Base Cost per acre DA ($)', value=6600)
    base_facility_cost = tab_object.number_input('Base Facility Cost (rounded p to nearest $100) ($)', value=13200)
    ...
    tab_object.subheader('Associated Capital Cots')
    ...
    total_base_facility_cost = tab_object.number_input('Total Base Facility Cost')
    total_associated_capital_cost = tab_object.number_input('Total Associated Capital Cost')
